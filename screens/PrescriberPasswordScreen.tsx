...
type RouteProp = RNRouteProp<RootStackParamList, "PrescriberPassword">;
...
export default function PrescriberPasswordScreen() {
  ...
  const formData = route.params?.formData as PrescriberFormData | undefined;
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Make API call to create prescriber
      // Note: Update the endpoint when you have the prescriber registration endpoint
      await axios.post(`${API_BASE_URL}/prescribers`, prescriberData, {
        headers: {
      ...
      Toast.show({
        ...
        text2: "Your prescriber account has been successfully created.",
        position: "top",
        visibilityTime: 3000,
      });
      ...
      console.error("Error creating prescriber:", err);

      let errorMessage =
        "Failed to create prescriber account. Please try again.";
