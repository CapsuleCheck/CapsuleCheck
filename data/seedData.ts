...
export const SEED_MEDICATION_PRICES: MedicationPrice[] = [
  {
    ...
    sources: [
      ...
      {
        id: "src-12",
        pharmacyName: "Sam's Club Pharmacy",
        price: 6.99,
        distance: 7.2,
        inStock: true,
        isGenericOffer: true,
...
export const SEED_REVIEWS: Review[] = [
  {
    ...
    rating: 5,
    comment:
      "Dr. Reed is thorough and takes time to explain everything. Highly recommend!",
    date: "2024-10-15",
    verified: true,
  },
  {
    ...
    rating: 4,
    comment:
      "Very knowledgeable and professional. Wait times can be long sometimes.",
    date: "2024-09-28",
    verified: true,
  },
  {
...
export const SEED_NOTIFICATIONS: Notification[] = [
  ...
  },
  {
    ...
    message:
      "You have an appointment with Dr. Evelyn Reed on Nov 25 at 11:30 AM",
